...
def yandex_weather_get():
    ...
    try:
        ...
        print(weather_temp_current)
        weather_cond_current = weather_dict[final["fact"]["condition"]]
        weather_day_temp = str(final["forecast"][0]["parts"]["day"]["temp_avg"])
        print(weather_day_temp)
        weather_day_cond = weather_dict[str(final["forecast"][0]["parts"]["day"]["condition"])]
        weather_evening_temp = str(final["forecast"][0]["parts"]["evening"]["temp_avg"])
        weather_evening_cond = weather_dict[str(final["forecast"][0]["parts"]["evening"]["condition"])]
        weather_morning_temp = str(final["forecast"][0]["parts"]["morning"]["temp_avg"])
        weather_morning_cond = weather_dict[str(final["forecast"][0]["parts"]["morning"]["condition"])]
